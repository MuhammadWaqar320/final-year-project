...
const Recommendations=(props)=>
{
    ...
    return (<>
    <Hidden mdDown="true">
    <Paper className={classes.BoxStyle} style={{marginTop:'0.6%'}}>
       
          <Grid  style={{paddingRight:'20px',paddingLeft:'20px',paddingTop:'20px'}}>
          <Box style={{display:'flex'}}>
          <Typography><h3 style={{fontFamily:'initial',color:'#081333'}}>{props.name}</h3></Typography>
          <NavLink to="#" style={{textDecoration:'none',marginLeft:'auto'}}>     <Button startIcon={<GridViewIcon />} className="SignInClass" variant="contained" style={{background:'#ffca44',textTransform:'capitalize',fontSize:'14px'}}>View All</Button></NavLink>
        </Box>
